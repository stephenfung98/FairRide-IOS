...
//    }
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        LyftConfiguration.developer = (token: "Kl9Ntq3juNkIzkWnC9bYH6d8pv7Ssdd5GWtiEllLB3c9QEYJBEeAMdBKCIlT3dKMsYu4L4+VhR00nLPvjb3jiXpLPuZuDkJZLwcAXilBb67rRwx6OpNUZcg=", clientId: "FUSRU_SIy08T")
        return true
    }
}
